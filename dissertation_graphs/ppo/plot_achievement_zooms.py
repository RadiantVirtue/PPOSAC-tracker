"""dissertation_graphs/ppo/plot_achievement_zooms.py

Achievement-centred zoom charts for PPO.
...
Output: ppo/output/zooms/<achievement>_<metric>.png
  e.g.  ppo/output/zooms/eat_cow_opposition_score.png

Usage (from PPOSAC-tracker/):
    python dissertation_graphs/ppo/plot_achievement_zooms.py --ppo_root ppo_experiment_root
"""
...
def _plot_zoom(ach_name: str, field: str, color: str, ylabel: str,
    ...
    ax.set_title(
        f"PPO — {ach_name.replace('_', ' ')}  |  {ylabel}\n"
...
def main():
    ...
    parser.add_argument("--out_dir",
                        ...
                        help="Output directory (default: ppo/output/zooms/)")
