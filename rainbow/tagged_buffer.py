"""Episode-tagged transition store for offline Rainbow analysis.

EpisodeStore accumulates transitions from the replay loop, tagging each with
...
analyze_checkpoint.py / analysis/run_rainbow_analysis.py for partitioning.
"""
import os
import pickle
